...
/**
 * com.hibernate.web.system.UserInfoController.java
 * ==============================================
 ...
 */
@RestController
@Api(value = "系统-用户表Controller", description = "系统-用户表相关api", tags = {"系统-用户表操作接口"})
...
public class UserInfoController {
    ...
    @ApiOperation(value = "获取系统-用户表列表", notes = "获取系统-用户表列表")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "获取单个系统-用户表详细信息", notes = "根据url的id来获取系统-用户表详细信息")
    ...
    @ApiOperation(value = "保存单个系统-用户表", notes = "根据UserInfo对象保存系统-用户表")
    @ApiImplicitParam(paramType = "body", name = "userInfo", value = "系统-用户表详细实体UserInfo", required = true, dataType = "UserInfo")
    ...
    @ApiOperation(value = "批量删除系统-用户表", notes = "根据url的ids来指定删除对象")
    @ApiImplicitParam(paramType = "form", name = "ids", value = "系统-用户表IDs", required = true, allowMultiple = true, dataType = "string")
