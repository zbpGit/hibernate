...
public class ClassUtil {
	 ...
	 * 
	 * @param <T> 对象类型
	 * @param classNameDotMethodName 类名和方法名表达式，类名与方法名用<code>.</code>或<code>#</code>连接 例如：com.xiaoleilu.hutool.StringUtil.isEmpty 或 com.xiaoleilu.hutool.StringUtil#isEmpty
