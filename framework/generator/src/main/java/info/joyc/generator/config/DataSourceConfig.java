...
import info.joyc.generator.config.converts.*;
import info.joyc.generator.config.querys.*;
import lombok.Data;
...
public class DataSourceConfig {
     ...
     * 数据库信息查询
     */
    private info.joyc.generator.config.IDbQuery dbQuery;
    /**
     * 数据库类型
     */
     ...
     * 类型转换
     */
    private info.joyc.generator.config.ITypeConvert typeConvert;
    /**
     * 驱动连接的URL
     */
    private String url;
