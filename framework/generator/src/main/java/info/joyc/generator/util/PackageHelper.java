 ...
 * the License.
 */
package info.joyc.generator.util;
...
public class PackageHelper {
    ...
    public static String[] convertTypeAliasesPackage(String typeAliasesPackage) {
        ...
        try {
            ...
            throw new RuntimeException("not find typeAliasesPackage: %s" + e + pkg);
        }
    }
    ...
    public static Set<Class> scanTypePackage(String typePackage) {
        ...
        try {
            ...
            throw new RuntimeException("not find scanTypePackage: %s" + e + pkg);
        }
    }
