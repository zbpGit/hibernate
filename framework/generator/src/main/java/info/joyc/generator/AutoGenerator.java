...
import info.joyc.generator.annotation.*;
import info.joyc.generator.config.*;
import info.joyc.generator.config.builder.ConfigBuilder;
import info.joyc.generator.config.po.TableInfo;
import info.joyc.generator.engine.AbstractTemplateEngine;
...
public class AutoGenerator {
    ...
    protected ConfigBuilder pretreatmentConfigBuilder(ConfigBuilder config) {
        ...
        List<String> plusPackages = new ArrayList<>();
        plusPackages.add(TableId.class.getCanonicalName());
        plusPackages.add(IdType.class.getCanonicalName());
        plusPackages.add(TableField.class.getCanonicalName());
        plusPackages.add(TableName.class.getCanonicalName());
        plusPackages.add(TableLogic.class.getCanonicalName());
        plusPackages.add(Version.class.getCanonicalName());
        /**
         * 表信息列表
         */
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            tableInfo.getImportPackages().removeIf(plusPackages::contains);
            // Boolean类型is前缀处理
