...
public class StrategyConfig {
     ...
     * 自定义继承的Mapper类全称，带包名
     */
    private String superMapperClass = info.joyc.generator.config.ConstVal.SUPER_MAPPER_CLASS;

    /**
     * 自定义继承的Service类全称，带包名
     */
    private String superServiceClass = info.joyc.generator.config.ConstVal.SUPER_SERVICE_CLASS;
