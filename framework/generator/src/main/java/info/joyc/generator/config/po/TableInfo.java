 ...
 * the License.
 */
package info.joyc.generator.config.po;
import info.joyc.generator.config.StrategyConfig;
import info.joyc.generator.config.rules.NamingStrategy;
import info.joyc.generator.util.CollectionUtils;
...
public class TableInfo {
            ...
            for (TableField field : fields) {
                ...
                if (field.isKeyFlag()) {
                    ...
                    if (field.isConvert() || field.isKeyIdentityFlag()) {
                        importPackages.add(info.joyc.generator.annotation.TableId.class.getCanonicalName());
                    }
                    // 自增
                    if (field.isKeyIdentityFlag()) {
                        importPackages.add(info.joyc.generator.annotation.IdType.class.getCanonicalName());
                    }
                } else if (field.isConvert()) {
                    // 普通字段
                    importPackages.add(info.joyc.generator.annotation.TableField.class.getCanonicalName());
                }
                if (null != field.getFill()) {
                    // 填充字段
                    importPackages.add(info.joyc.generator.annotation.TableField.class.getCanonicalName());
                    importPackages.add(info.joyc.generator.annotation.FieldFill.class.getCanonicalName());
                }
            }
        }
    }
    ...
    public List<String> getFieldNameList() {
        return this.fields.stream().map(m -> m.getName()).collect(Collectors.toList());
    }
}
